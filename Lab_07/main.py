...
# Crear el dendrograma y capturar las coordenadas de los enlaces
plt.figure(figsize=(10, 7))
dendro = dendrogram(linkage_matrix, labels=elementos_originales)

# Agregar las anotaciones en medio de las uniones
for i, d in zip(dendro['icoord'], dendro['dcoord']):
    x = 0.5 * sum(i[1:3])
    y = d[1]
    plt.annotate(f'{y:.2f}', (x, y), ha='center', va='bottom')
